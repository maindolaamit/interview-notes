...
PasteBin is a web application that allows users to upload code snippets to a server and get a randomly generated URL to access it.
Thi URL can be shared with others as plain text.
Users can also copy and paste snippets that have been uploaded by others without having to create an account.
