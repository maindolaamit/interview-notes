...
- **A service to generate the news feed
- **A service to publish the feed to the user
...
*/
void generateFeed(api_dev_key, user_id)
...
*/
List<Post> getFeed(api_dev_key, user_id)
    returns list of posts
```
