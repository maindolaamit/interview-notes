...
With size defined time taken will be significantly faster due to following reasons.
...
// returns fixed size list immutable list, we can not add or remove elements.
// allows null values
// throws UnsupportedOperationException
List<Integer> list = List.of("Amit","Prashant","Suresh");
list.add("Ramesh");

// returns fixed size modifiable list, we can not add or remove elements
// allows null values
...
class Example{
    public static void main(){
        ...
        map.put(Days.MONDAY, "First day of the week");
        map.put(Days.TUESDAY, "Second day of the week");
        map.put(Days.WEDNESDAY, "Third day of the week");
