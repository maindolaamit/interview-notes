---
title: Transactions & JTA 
description: "Local Transactions, JTA and 2‑Phase Commit"
sidebar_position: 4
---

Spring Boot supports both local and distributed transactions. This section explains:

## Local Transactions
* Managed automatically by Spring with `@Transactional`.
* Best for single data source scenarios using connection pools.

## Distributed Transactions with JTA

* **JTA (Java Transaction API):** Required for distributed transactions involving multiple resource managers.
* **Two‑Phase Commit (2PC):** Ensures atomic commitment across resources.
* **Dependencies:** Typically use Atomikos or Bitronix via Spring Boot starters.
  
:::tip JTA Tips
- Only use JTA when dealing with multiple data sources.
- Be mindful of performance trade‑offs due to transaction context switching.
:::
...
<!-- Or use the Bitronix Spring Boot starter -->
<dependency>
    <groupId>org.springframework.boot</groupId>
...
1. Include the JTA dependency.
2. Configure the transaction manager bean.
3. Set persistence unit’s transaction type to JTA.

**Image Suggestion:**  
A diagram showing the two‑phase commit flow in a JTA setup.  
(Consider creating: `/Users/amaindola/github/interview-notes/docs/languages/2-spring-boot/data/img/two-phase-commit.png`)
