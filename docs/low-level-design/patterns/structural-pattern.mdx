...
The Facade pattern is used to provide a simple interface to a complex subsystem. The Facade pattern is used to provide a simple interface to a complex subsystem.
</details>

<details>
<summary>Flyweight Pattern</summary>
The Flyweight pattern is used to reduce the memory footprint of objects. The Flyweight pattern is used to reduce the memory footprint of objects.
</details>
