    ...
    <TabItem value="GraphQL">
       ...
       **Challenges of GraphQL:**
        ...
        results based on the input variables.
            ...
            :::warning
            While GraphQL theoretically can handle writes as well as reads, it doesn’t seem to fit as well as it is for reads.
...
[Messaging Protocols](./message-brokers) are discussed in detail in the next section.
